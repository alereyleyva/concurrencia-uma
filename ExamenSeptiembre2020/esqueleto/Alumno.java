...
public class Alumno extends Thread {
	...
	public void run() {
		try {
			...
			// El alumno informa que ha terminado la parte de iniciacion y libera su
			// conexion
			...
			// El alumno espera a que haya plaza en la parte avanzada y que se forme el
			// grupo de 3 miembros
			curso.esperaPlazaAvanzado(id);
			// El alumno cursa la parte avanzada
			Thread.sleep(id * rnd.nextInt(500));
			// El alumno informa que ha terminado su parte y espera a que todos los miembros
			// del grupo terminen
