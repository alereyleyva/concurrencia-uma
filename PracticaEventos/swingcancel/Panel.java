...
public class Panel extends JPanel {
    ...
    public void setBotonComenzar() {
        ...
        boton.setActionCommand(Panel.COMENZAR);
    }

    public void setBotonCancelar() {
        boton.setText("Cancelar");
        boton.setActionCommand(Panel.CANCELAR);
    }
    ...
    public boolean procesoTerminado() {
        return progresoLeibniz.getValue() == 100 && progresoMonteCarlo.getValue() == 100;
    }

    public void resetearProgreso() {
        progresoLeibniz.setValue(0);
        progresoMonteCarlo.setValue(0);
    }
