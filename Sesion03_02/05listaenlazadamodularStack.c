...
gcc principal.c liberia.c -o salida.exe

¿Cómo indico esto en el task.json? Para ello puedes crear una tarea o rehusar la existente y escribir a mano la compilación para el proyecto en cuestion.
"args": [
...
Ejercicio
1.- Implementa la clase stack, en la que se meten y se sacan elementos por la cabeza y y comprueba que funciona correctamente. REcuerda modificar el task.json para que compile la liberia junto a este archivo.
